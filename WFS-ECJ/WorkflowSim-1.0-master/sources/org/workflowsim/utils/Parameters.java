...
public class Parameters {
    ...
    public enum SchedulingAlgorithm {
        ...
        MAXMIN, MINMIN, MCT, DATA, HEFT, GP,
    ...
    public enum PlanningAlgorithm{
        INVALID, RANDOM, HEFT, DHEFT, FSGPHEFT
    }
    ...
    public static GPUtility getGpUtility() {
        return gpUtility;
    }

    public static void setGpUtility(GPUtility gpUtility) {
        Parameters.gpUtility = gpUtility;
    }

    /**
     * Parameters for WFSGP
     * */
    private static GPUtility gpUtility;
