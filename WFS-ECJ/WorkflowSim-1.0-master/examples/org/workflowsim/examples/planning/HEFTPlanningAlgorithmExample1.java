...
public class HEFTPlanningAlgorithmExample1 extends WorkflowSimBasicExample1 {
    ...
    protected static List<CondorVM> createVM(int userId, int vms) {
        ...
        for (int i = 0; i < vms; i++) {
            ...
            if (i == 0){ ratio = 0.923157115686327; }
            else if (i == 1){ ratio = 0.9785439788010425; }
            else if (i == 2){ ratio = 0.11844081508286086; }
            else if (i == 3){ ratio = 0.9779063368009382; }
            else if (i == 4){ ratio = 0.5325349521385307; }
            Log.printLine("Ratio i: "+i+" is: "+ratio);
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             */
            String daxPath = "/Users/koe/Documents/Gitlab-Thesis/thesis/workflowsim/WorkflowSim-1.0-master/config/dax/Montage_25.xml";
